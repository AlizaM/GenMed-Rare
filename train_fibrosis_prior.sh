...
# ============================================================================
# Prior-Based Fibrosis Diffusion Training
# ============================================================================
# This script trains a diffusion model for fibrosis generation using
# prior-based learning with healthy chest X-rays.
#
# Data: Small enough to stay in home directory (no scratch needed)
# ============================================================================
...
# Track venv location on scratch (reuse existing venv)
VENV_LOCATION_FILE="$PROJECT_DIR/.scratch_venv_location"

# HDD storage for outputs (not home directory - that has small quota)
W_STORAGE_BASE="/w/20251/alizat"

# Output directory for this training run
JOB_ID="${SLURM_JOB_ID:-local}"
OUTPUT_DIR="$W_STORAGE_BASE/diffusion_outputs/fibrosis_prior_job_${JOB_ID}"

# Files
CONFIG_FILE="$PROJECT_DIR/configs/config_diffusion_fibrosis.yaml"
...
# ============================================================================
echo "============================================================================"
echo "Prior-Based Fibrosis Diffusion Training"
echo "============================================================================"
echo "Job ID: $JOB_ID"
echo "Node: $(hostname)"
echo "Date: $(date)"
...
# Read the original config and update the output_dir path
python3 << EOF
import yaml
...
# TEMP_CONFIG is already in OUTPUT_DIR, so no need to copy
