#!/bin/bash
#SBATCH --job-name=Pneum_Prior_SD_TEST
...
# =========================================================================
# Prior-Based Pneumonia Diffusion Training (TEST)
# =========================================================================
set -e
...
OUTPUT_DIR="$W_STORAGE_BASE/diffusion_outputs/pneumonia_prior_test_job_${JOB_ID}"
CONFIG_FILE="$PROJECT_DIR/configs/config_diffusion_pneumonia_test.yaml"
TRAINING_SCRIPT="$PROJECT_DIR/scripts/train_diffusion_prior.py"

# PRE-FLIGHT CHECKS

echo "============================================================================"
echo "Prior-Based Pneumonia Diffusion Training (TEST)"
echo "============================================================================"
echo "Job ID: $JOB_ID"
echo "Node: $(hostname)"
echo "Date: $(date)"
